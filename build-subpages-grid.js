...
Object.entries(pagesData).forEach(([route, data]) => {
  ...
  const contentLines = [
    ...
    "                 <div>",
    "                    <p className=\"text-xs uppercase tracking-[0.3em] font-medium text-accent mb-2\">Bespoke Garment</p>",
    ...
    "                       Every piece from our gallery serves as a foundation for your bespoke commission. " + data.tech + " Feel free to inquire about exact pricing based on customized fabrics and fit detailing.",
    "                    </p>",
    "                 </div>",
    "",
