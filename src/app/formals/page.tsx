  ...
  return (
    <div className="min-h-screen pt-48 pb-24 bg-[#0a0a09]">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <FadeIn className="flex flex-col lg:flex-row w-full gap-4 mb-32 h-[100vh] lg:h-[70vh]">
          {[
            ...
            { title: 'Shirts', href: '/formals/shirts', desc: 'The foundational standard', image: '/images/formals-shirt.jpg' }
              ...
              <Link key={c.title} href={c.href} className="group flex-1 relative border border-white/10 hover:border-accent/50 p-6 md:p-8 flex flex-col justify-end transition-all duration-[3000ms] ease-in-out bg-black/40 overflow-hidden hover:flex-[2]">
