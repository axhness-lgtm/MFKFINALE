  ...
  return (
    <html lang="en" className="dark">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Josefin+Slab:ital,wght@0,300;0,400;0,600;1,300;1,400&family=Playfair+Display:ital,wght@0,300;0,400;1,300&family=Pinyon+Script&family=Ballet&family=Gwendolyn:wght@400;700&display=swap" rel="stylesheet" />
      </head>
