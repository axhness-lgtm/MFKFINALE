...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'MF Khan International - Luxury Menswear Vizag',
    description: 'Vizag’s premier tailoring house since 1940. Specializing in wedding suits and ceremonial wear.',
    images: ['/og-home.jpg'],
  }
};
