  ...
  const rightLinks = [
    {
      ...
      dropdown: [
        { name: 'Fabric Collections', href: '/custom-tailoring#fabric-collections' },
        { name: 'Fittings', href: '/custom-tailoring/fittings' },
        { name: 'Hand Work', href: '/custom-tailoring/hand-work' },
        { name: 'Guide / Process', href: '/custom-tailoring/process' },
      ]
    },
          ...
          >
            ...
            <div className="p-10 border-b border-white/5 bg-white/5 flex items-center justify-between">
              <Link href="/contact" className="flex items-center gap-4 group">
                <div className="w-10 h-10 flex-shrink-0 rounded-full border border-accent/20 flex items-center justify-center bg-accent/5 group-hover:bg-accent/20 transition-colors">
              ...
              <button
                onClick={() => setMobileMenuOpen(false)}
                className="absolute top-8 right-8 p-3 text-white/60 hover:text-white bg-white/5 rounded-full"
              >
                <X className="w-6 h-6" />
              </button>
            </div>
            ...
            {/* Sidebar Footer */}
            <div className="p-8 border-t border-white/10 bg-[#050505] space-y-8">
              {/* Inquiry */}
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-[8px] uppercase tracking-[0.3em] text-white/30 mb-1">Inquiry </p>
                  <p className="text-sm text-white font-bold tracking-widest">+91 91821 67662</p>
                </div>
              </div>

              {/* Region Select Mockup */}
              <div className="flex flex-col gap-4">
                <div className="flex items-center justify-between p-4 bg-white/[0.03] border border-white/5 rounded-sm text-white/50 text-[9px] uppercase font-bold tracking-[0.2em]">
