    ...
    <section className="pt-16 pb-32 px-6 md:px-12 bg-[#0a0a09] overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <FadeIn className="text-center space-y-4 mb-24">
          ...
          <h2 className="text-3xl md:text-5xl font-light text-white" style={{ fontFamily: '"Playfair Display", serif' }}>Testimonials</h2>
        </FadeIn>
          ...
          {testimonials.map((t, idx) => (
            <FadeIn key={idx} delay={idx * 200} className="space-y-10 relative">
              ...
              <div className="space-y-1 pt-6 border-t border-white/20">
                ...
                <p className="text-xl gold-text italic" style={{ fontFamily: '"Times New Roman", serif', fontWeight: 400 }}>{t.role}</p>
              </div>
            </FadeIn>
          ))}
        </div>
