...
export function HeritageMain() {
  return (
    <div className="min-h-screen flex flex-col bg-[#080505]">
      <Header />

      <main className="flex-grow pt-24 md:pt-32">
        {/* ── HERO SECTION ── */}
        <section className="relative px-6 md:px-12 pt-8 md:pt-16 pb-20 overflow-hidden bg-gradient-to-b from-[#050505] to-[#0a0a09]">
            ...
            <FadeIn>
              <div className="flex flex-col items-center">
                ...
                <div className="relative p-3 md:p-4 mb-16 md:mb-20 inline-block group">
                   ...
                   {/* Main Frame */}
                   <div className="relative p-2 md:p-3 border-[1px] border-accent/40 rounded-t-[100px] shadow-[0_0_50px_rgba(196,163,101,0.1)] bg-[#0a0a09]/50 overflow-hidden">
                      ...
                      <div className="relative w-48 h-64 md:w-64 md:h-[320px] overflow-hidden rounded-t-[100px] bg-black inner-shadow">
                        ...
                        <Image 
                          ...
                          alt="Mohd. Faizulla Khan, Founder of M.F. KHAN & CO. (1922 - 1980)" 
                          fill 
                          className="object-cover object-top grayscale contrast-125" 
                        />
                        <div className="absolute bottom-5 left-0 right-0 text-center z-20">
                           <p className="text-accent text-[10px] md:text-xs uppercase tracking-widest font-light">Mohammed Faizulla Khan</p>
                        </div>
                      </div>
                   </div>
                </div>
                ...
                <div className="relative w-full px-2">
                   ...
                   <h1 className="text-3xl md:text-5xl lg:text-7xl text-white font-light leading-[1.4] md:leading-[1.2] mb-6 md:mb-8" style={{ fontFamily: '"Cormorant Garamond", serif' }}>
                     <Link href="/heritage" className="text-white hover:text-accent transition duration-500">MF Khan</Link> <br className="hidden md:block" />
                   ...
                   <p className="text-[#E8E0D0]/80 text-sm md:text-lg font-light max-w-2xl leading-relaxed mx-auto italic px-4" style={{ fontFamily: '"Cormorant Garamond", serif' }}>
                     Today, clients visit MFKhan International not just for clothing, but for complete wedding styling, from custom <Link href="/wedding/designer-suits" className="text-accent transition-colors hover:text-white underline decoration-accent/20 hover:decoration-accent underline-offset-4">suits</Link> to <Link href="/wedding/sherwani" className="text-accent transition-colors hover:text-white underline decoration-accent/20 hover:decoration-accent underline-offset-4">sherwanis</Link>, all crafted with the same standard set in 1940.
                   </p>
                </div>
              </div>
            </FadeIn>
        ...
        <section className="bg-[#0a0a09] py-20 md:py-28 px-6 md:px-12 border-t border-white/[0.05]">
            ...
            <div className="text-[#E8E0D0]/80 font-light leading-relaxed text-base md:text-lg space-y-8" style={{ fontFamily: '"Spectral", serif' }}>
              <FadeIn delay={100}>
                <p>
                  ...
                  <Link href="/heritage" className="text-white hover:text-accent transition-colors">F Khan</Link> is the name by which Visakhapatnam's most enduring menswear house is known — and the name is not a brand construct. It is a man's name, abbreviated and passed down through generations as a mark of trust. <Link href="/heritage" className="text-accent hover:underline">MF Khan</Link> refers to Mohammed Faizulla Khan, the founder who established MFKHAN & Co. Men's Shop on Kurupam market, Visakhapatnam in 1940 — making it one of the oldest continuously operating luxury menswear establishments in Andhra Pradesh.
                </p>
              </FadeIn>
              <FadeIn delay={200}>
                <p>
            ...
            <FadeIn delay={300}>
               <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                  {[
                     ...
                     <div key={i} className="p-8 border border-white/5 bg-[#0a0a09] flex flex-col justify-between hover:border-accent/20 transition-colors">
            ...
            <div className="pt-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
               <FadeIn className="lg:col-span-7 order-2 lg:order-1">
                  ...
                  <div className="mt-4 text-center pb-4 border-b border-white/10 max-w-sm mx-auto">
                     <p className="text-white/50 text-[10px] tracking-widest uppercase">The Original Storefront • Kurupam Market, 1940</p>
                  </div>
               </FadeIn>
               ...
               <div className="lg:col-span-5 order-1 lg:order-2">
                  ...
                  <div className="space-y-6 text-[#E8E0D0]/80 font-light leading-relaxed text-base md:text-lg" style={{ fontFamily: '"Spectral", serif' }}>
                     <FadeIn delay={100}>
                        <p>
                           In 1940, Mohammed Faizulla Khan opened MFKHAN & Co. Men's Shop — at a time when the city's appetite for quality menswear was met almost entirely by imported or mass-produced goods. He entered that gap with something neither could offer: personal accountability for every garment.
                        </p>
                     </FadeIn>
                     <FadeIn delay={200}>
                        <p className="pl-5 border-l border-accent/30 italic text-white/90">
                           Even today, grooms across Vizag rely on <Link href="/heritage" className="text-accent underline decoration-accent/30 hover:decoration-accent underline-offset-4">MF Khan</Link> for their wedding attire, from tailored <Link href="/wedding/designer-suits" className="text-white hover:text-accent transition-colors">suits</Link> to traditional <Link href="/wedding/sherwani" className="text-white hover:text-accent transition-colors">sherwanis</Link>.
                        </p>
                     </FadeIn>
                     <FadeIn delay={300}>
                        <p>
            ...
            <div className="pt-24 pb-8 text-center max-w-2xl mx-auto">
               ...
               <FadeIn delay={100}>
                 <p className="text-[#E8E0D0]/80 font-light leading-relaxed text-base md:text-lg" style={{ fontFamily: '"Spectral", serif' }}>
                   By the time Mohammed Faizulla Khan's son, Mohammed Ahmed Ali Khan, assumed the next chapter of the house, <Link href="/heritage" className="text-accent">MF Khan</Link> had become something that transcends branding: a shorthand for a standard. Clients in Visakhapatnam did not say they were going to buy a suit. They said they were going to <Link href="/heritage" className="text-accent">MF Khan</Link>.
                 </p>
        ...
        {/* ── GENERATION II ── */}
        <section className="bg-gradient-to-b from-[#080808] to-[#111] py-20 md:py-28 px-6 md:px-12 border-t border-white/[0.05]">
           <div className="max-w-4xl mx-auto">
             ...
             <FadeIn delay={100} className="mb-16">
               <div className="relative w-full aspect-[16/9] md:aspect-[21/9] border border-white/10 p-2 bg-[#050505] shadow-2xl">
                 <div className="relative w-full h-full">
             ...
             <div className="space-y-16 text-[#E8E0D0]/80 font-light leading-relaxed text-base md:text-lg" style={{ fontFamily: '"Spectral", serif' }}>
                <FadeIn delay={100}>
                  ...
                  <p className="mt-8 text-center text-white/70 max-w-3xl mx-auto">
                     What did change — and what defines his contribution to the <Link href="/heritage" className="text-white hover:text-accent transition">MF Khan</Link> legacy — was scale, sourcing, and institutional presence. He applied his father's founding philosophy to a world where luxury had gone global.
                  </p>
                </FadeIn>
                ...
                <div className="mt-20 space-y-24">
                  ...
                  <FadeIn delay={100} className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
                    ...
                    <div className="order-1 md:order-2 relative aspect-[4/5] md:aspect-square w-full shadow-2xl bg-[#111] p-2 border border-white/10">
                      <div className="relative w-full h-full">
                        <Image src="/images/archive/generation-2-fabrics.jpg" alt="The Fabric Vault" fill className="object-cover grayscale opacity-90" />
                      </div>
                    </div>
                  </FadeIn>
                  ...
                  <FadeIn delay={300} className="pt-12">
                    ...
                    <div className="relative aspect-[16/9] w-full shadow-2xl bg-[#111] p-2 border border-white/10">
                      <div className="relative w-full h-full">
                        <Image src="/images/archive/generation-2-store.jpg" alt="Rednam Gardens Flagship Interior" fill className="object-cover object-bottom grayscale opacity-90" />
                      </div>
                    </div>
                  </FadeIn>
                ...
                <FadeIn delay={400}>
                   <div className="bg-[#050505] border border-white/5 p-8 md:p-12 text-center mt-8">
        ...
        <section className="bg-[#080505] py-20 md:py-28 px-6 md:px-12 border-t border-white/5">
           <div className="max-w-4xl mx-auto space-y-16">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
                <FadeIn delay={100} className="space-y-6 text-[#E8E0D0]/80 font-light leading-relaxed text-base md:text-lg" style={{ fontFamily: '"Spectral", serif' }}>
                   <p>
                     The third generation did not inherit <Link href="/heritage" className="text-white hover:text-accent font-medium transition-colors">MF Khan</Link> by succession plan. They entered it by choice. Mohammed Akbar Ali Khan and his brothers stepped into the house their grandfather had founded — as professionals understanding that a legacy requires active stewardship.
                   </p>
                   <p>
                     Under their leadership, MFKHAN International at <Link href="/contact" className="text-accent hover:underline">Rednam Gardens</Link> is the definitive destination for <Link href="/wedding/sherwani" className="text-white hover:text-accent underline decoration-white/20 hover:decoration-accent transition-colors">MF Khan wedding wear Visakhapatnam</Link>.
                   </p>
                </FadeIn>
                
                <FadeIn delay={200} className="border-l border-accent/30 pl-8 py-4">
        ...
        {/* ── CONCLUSION ── */}
        <section className="bg-black py-24 md:py-32 px-6 md:px-12 border-t flex flex-col items-center justify-center border-accent/20">
           <div className="max-w-3xl mx-auto text-center space-y-12">
             ...
             <FadeIn delay={100}>
                <p className="text-[#E8E0D0]/80 md:text-lg leading-relaxed font-light" style={{ fontFamily: '"Spectral", serif' }}>
                  From a 100-rupee beginning in Kakinada to a flagship at <Link href="/contact" className="text-white hover:text-accent underline decoration-white/20">Rednam Gardens</Link>, <Link href="/heritage" className="text-accent">MF Khan</Link> remains a name that stands for consistency, precision, and trust. Today, clients visit MFKhan International not just for clothing, but for complete wedding styling.
                </p>
             </FadeIn>
