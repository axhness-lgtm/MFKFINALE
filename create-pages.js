    ...
    <div className="min-h-screen pt-32 pb-24 bg-[#0a0a09]">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-32">
          {[
            { title: 'Designer Suits', href: '/wedding/designer-suits', desc: 'Modern wedding suits' },
            { title: 'Indo-Western', href: '/wedding/indo-western', desc: 'Fusion garments' },
            { title: 'Sherwani', href: '/wedding/sherwani', desc: 'Traditional wedding wear' },
            { title: 'Designer Shirts', href: '/wedding/designer-shirts', desc: 'Supporting pieces' }
          ].map((c, i) => (
...
export default function Wedding\${p.slug.replace(/-/g, '')}Page() {
  return (
    ...
    <div className="min-h-screen pt-32 pb-24 bg-[#0a0a09]">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-32">
          {[
            { title: 'Business Suits', href: '/formals/business-suits', desc: 'The authoritative uniform' },
            { title: 'Blazers', href: '/formals/blazers', desc: 'Versatile structured elegance' },
            { title: 'Shirts', href: '/formals/shirts', desc: 'The foundational standard' }
          ].map((c, i) => (
            <FadeIn key={c.title} delay={i * 100}>
...
export default function Formals\${p.slug.replace(/-/g, '')}Page() {
  return (
    <div className="min-h-screen pt-40 pb-24 bg-[#0a0a09]">
      <div className="max-w-4xl mx-auto px-6 md:px-12">
        <FadeIn className="text-center space-y-6 mb-24">
...
export default function Custom\${p.slug.replace(/-/g, '')}Page() {
  return (
    <div className="min-h-screen pt-40 pb-24 bg-[#0a0a09]">
